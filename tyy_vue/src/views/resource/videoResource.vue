<template>
  <div class="app-container">
    ...
    <el-dialog v-dialog-drag  title="资源预览" :visible.sync="v_preshow">
      <div style="max-width: 60vw;max-height: 40vw;display: flex;justify-content: center;align-items: center">
        <img style="width: 40vw;height: 30vw;" :src="url_preshow" alt="预览资源"/>
      </div>
    ...
    >
      ...
      <el-table-column align="center" label="操作" min-width="80">
        <template slot-scope="scope">
          <el-button type="primary" @click="preShow(scope.row.url)">预览</el-button>
