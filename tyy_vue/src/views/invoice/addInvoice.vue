<template>
  <div class="app-container">
    ...
    <select-dis-in-inv :dis-info="disInfo" @selectingDis="selectingDis"></select-dis-in-inv>
...
<script>
  ...
  import selectDisInInv from '@/views/invoice/selectDisInInv'
  ...
  export default {
    ...
    components: {
      UploadImages,
      orderInfo,
        channelSelect,priceInput,priceShow,selectDisInInv
    },
