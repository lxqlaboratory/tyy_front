<template>
  <div class="app-container">
      ...
      <el-col :span="2" style="display: flex;flex-direction: column;align-items: flex-start;justify-content: flex-end">
          <el-popover
            ...
            <div>
              ...
              <el-checkbox v-model="listTitleFilter.disName"  @change="saveLocalStorge">业务员</el-checkbox>
    ...
    >
      ...
      <el-table-column v-if="listTitleFilter.disName" align="center" label="业务员" prop="orderNum" width="200">
        <template slot-scope="scope">
          {{ scope.row.disName }}
        </template>
      </el-table-column>
...
<script>
  import {getSecDisOrders} from "@/api/order"
  ...
  export default {
    ...
    created() {
      ...
      console.log("ssss"+this.$route.query.id)
      this.onLoading = true
      getSecDisOrders(adminId).then(res => {
