<template>
  <div class="app-container">
    ...
    <el-table
      ...
      v-loading="onLoading"
    >
      <el-table-column align="center" label="资源编号" min-width="45">
      ...
      <el-table-column align="center" label="操作" min-width="45">
        <template slot-scope="scope">
          <el-button type="text" style="color: red" @click="">预览</el-button>
          <el-button type="text" style="color: red" @click="delResource(scope.row.rId)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getTypeList() {
                getResourceTypeList(this.superType).then(res => {
            ...
            addResType() {
                this.isOnAdd = true
                addResourceType(this.superType, this.resourceTypeForm.typeName).then(res => {
                    this.$message({
                        type: 'success',
                        message: '保存成功'
                    });
