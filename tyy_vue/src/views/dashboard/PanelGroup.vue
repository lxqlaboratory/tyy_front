    ...
    <el-col :lg="6" :sm="12" :xs="12" class="card-panel-col">
      <div @click="handleSetLineChartData('newVisitis')" class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :duration="1000" :end-val="pgdata.groupSum/100" :start-val="0" class="card-panel-num"/>
<!--          <price-show :price="pgdata.groupSum" ></price-show>-->
        </div>
      </div>
    </el-col>
    <el-col :lg="6" :sm="12" :xs="12" class="card-panel-col">
      <div @click="handleSetLineChartData('messages')" class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :duration="1000" :end-val="pgdata.inPaySum/100" :start-val="0" class="card-panel-num"/>
        </div>
      </div>
    </el-col>
    <el-col :lg="6" :sm="12" :xs="12" class="card-panel-col">
      <div @click="handleSetLineChartData('purchases')" class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :duration="1000" :end-val="pgdata.outPaySum/100" :start-val="0" class="card-panel-num"/>
        </div>
      </div>
    </el-col>
    <el-col :lg="6" :sm="12" :xs="12" class="card-panel-col">
      <div @click="handleSetLineChartData('shoppings')" class="card-panel">
        ...
        <div class="card-panel-description">
          ...
          <count-to :duration="1000" :end-val="pgdata.errPaySum/100" :start-val="0" class="card-panel-num"/>
        </div>
      </div>
    </el-col>
  </el-row>
