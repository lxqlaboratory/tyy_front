    ...
    >
      ...
      <el-table-column align="center" fixed="right" label="操作" min-width="300">
        <template slot-scope="scope">
          ...
          <el-button @click="resOrder(scope.row.orderId)" icon="el-icon-refresh-left" size="mini">还原订单</el-button>
        </template>
      </el-table-column>
...
<script>
  ...
  import {getNewTouList,getRecycleWeChatOrders,restoreRecOrders} from "@/api/order"
