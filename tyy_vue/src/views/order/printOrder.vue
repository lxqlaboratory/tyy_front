              ...
              <td align="center" bgcolor="#FFFFFF" >
                ...
                <table border="1" cellspacing="0" cellpadding="0" width="700">
                  ...
                  <tr>
                    ...
                    <td>&nbsp;{{orderForm.disName}}</td>
                    <td align="center">确 认 人</td>
                    <td width="230">&nbsp;{{orderForm.uName}}</td>
                  </tr>
                  <tr>
                    <td align="center">传 真 号</td>
                    <td>&nbsp;&nbsp;{{orderForm.disFax}}</td>
                    <td align="center">邮箱地址</td>
                    <td>&nbsp;{{orderForm.uEmail}}</td>
                  </tr>
                  <tr>
                    <td align="center">收 件 人</td>
                    <td>&nbsp;&nbsp;{{orderForm.disContactor}}</td>
                    <td align="center">联系电话</td>
                    <td>&nbsp;{{orderForm.uPhone}}</td>
                  </tr>
                  <tr>
                    <td align="center">联系电话</td>
                    <td>&nbsp;{{orderForm.disPhone}}</td>
                    ...
                    <td align="left">
                      ...
                      <table width="700" border="0" cellspacing="0" cellpadding="8" bordercolordark="#FFFFFF"
                        ...
                        <tr>
                          ...
                          <td align="right" bgcolor="#E3E3E3"><strong>&nbsp;订单编号：</strong>{{orderForm.orderNum}}&nbsp;
                          </td>
                        </tr>
                        <tr>
...
<script>
    import {addOrder, getPrintOrder} from "@/api/order"
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                getPrintOrder(this.$route.query.id).then(res => {
                    this.orderForm = res;
                    console.log(res);
                })
            }
