  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="操作" min-width="30">
        <template slot-scope="scope">
          <el-button @click="toGroup(scope.row.id)">团队信息</el-button>
          <el-button @click="groupMap(scope.row.id)" type="primary">集合地图</el-button>
          ...
          <el-button v-show="false" @click="editGroup(scope.row.id)" type="warning" v-if="scope.row.groupState===0 && $_has('GROUPUPDATE')">编辑</el-button>
