...
<script>
	...
	export default {
		...
		data() {
			...
			return {
				...
				ListHa: [{
						type: 'image',
						id: 'productImage',
						url: 'https://img3.redocn.com/tupian/20181229/yiqiqulvyouhaibao_10002067.jpg',
						dx: 0,
						dy: 0,
						dWidth: 1080,
						dHeight: 2000
					},
					{
						type: 'image',
						id: '2',
						url: 'https://ss3.bdstatic.com/70cFv8Sh_Q1YnxGkpoWK1HF6hhy/it/u=1351023557,3079306952&fm=26&gp=0.jpg',
						dx: 0,
						dy: 0,
						dWidth: 750,
						dHeight: 100
					...
					},
					{
						type: 'image',
						id: 'productImage3',
						url: 'https://cdn.lionstudio.top/FjfrfMcNyYcr59mOQxHoY4rFrzLV',
						dx: 0,
						dy: 1720,
						dWidth: 200,
						dHeight: 200
		...
		methods: {
			...
			okceshi() {
				ceshihaibao({
					code: this.code,proLList: this.proLList
				}).then(res => {
					// this.shareFc()
				}).catch(err => {})
				// this.shareFc()
