		...
		<view class="login-form">
			<form @submit="formSubmit">
				<view class="form-input">
					<input type="text" v-model="loginName" placeholder="请输入注册时手机号" />
				</view>
				<view class="form-input">
					<input type="password" v-model="password" placeholder="请输入密码" @focus="passwordF_B" @blur="passwordF_B" />
				</view>
