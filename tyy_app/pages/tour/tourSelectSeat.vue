<template>
    <view class="scroll " ref="wrapper" id="wrapper" style="500px">
		...
		<view class="cu-bar bg-white bottom-fix">
		    <view class="padding-lr">
		        <view class="text-xl text-orange2"><text class="text-sm"></text>点击座位抢座</view>
		        <view class="text-sm text-gray">接受预定</view>
		    </view>
		    <view class="padding-lr">
		        <button class="cu-btn bg-gradual-orange" @click="gotoBuy()">确认</button>
		    </view>
		</view>
    </view>
</template>
