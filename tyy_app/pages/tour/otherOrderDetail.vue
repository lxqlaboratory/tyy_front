...
import {
	...
	export default {
		...
		onLoad(options) {
			...
			otherGetOrderMoneyInit({  orderId: this.orderId,tourList:this.tourList,touristIds:this.touristIds,region:this.region })
				.then(res => {
