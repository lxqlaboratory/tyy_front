...
<script>
import { getToken } from '../api/base/baseApi.js';
...
export default {
	...
	created() {
		...
		//    }, 1000);
		this.imageList=this.$props.receiveImage
			...
			return new Promise((resolve, reject) => {
				...
				this.uploadTask = uni.uploadFile({
					...
					success(uploadFileResult) {
						...
						that.imageList[that.imageList.length - 1].rId=uploadFileRes.data.rId
