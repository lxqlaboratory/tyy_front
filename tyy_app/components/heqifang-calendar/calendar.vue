<template>
	<view class="uni-calendar" @touchmove.stop.prevent="clean">
		...
		<view v-if="insert || show" class="uni-calendar__content" :class="{'uni-calendar--fixed':!insert,'uni-calendar--ani-show':aniMaskShow}">
			<view v-if="!insert"  class="uni-calendar__header uni-calendar--fixed-top" style="padding: 8px;justify-content: space-between;height: auto;">
				<view class="uni-calendar__header-btn-box" style="background-color: #ED1C24;width: 80px;height: auto;border-radius: 5px;padding: 5px;" @click="cancel">
					<text class="uni-calendar__header-text uni-calendar--fixed-width" style="color: #FFFFFF;">取消</text>
				</view>
				<view class="uni-calendar__header-btn-box" style="background-color: #39B54A;width: 80px;height: auto;border-radius: 5px;padding: 5px;" @click="confirm">
					<text class="uni-calendar__header-text uni-calendar--fixed-width" style="color: #FFFFFF;">确定</text>
				</view>
			</view>
